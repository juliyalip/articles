  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="/register"
          element={<PublicRouter path='/create-article' restricted><RegisterPage /></PublicRouter>} />


        <Route path="/login" element={<PublicRouter path='/create-article' 
        restricted><LoginPage /></PublicRouter>} />
